...
public class abc extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/myy", "root", "");
            Statement stmt = con.createStatement();
            String query = "INSERT INTO myy(F_Name,L_Name,NIC_No,UsserName,Password,Address) VALUES('" + F_Name + "','" + L_Name + "','" + Nic + "','" + UserName + "','" + Password + "','" + Address + "')";
